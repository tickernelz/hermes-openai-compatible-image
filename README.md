...
```bash
curl -fsSL https://raw.githubusercontent.com/tickernelz/hermes-openai-compatible-image/v0.2.1/install.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/tickernelz/hermes-openai-compatible-image/v0.2.1/install.sh | bash -s -- --dry-run
```

Noninteractive / CI install for a known existing Hermes provider:

```bash
curl -fsSL https://raw.githubusercontent.com/tickernelz/hermes-openai-compatible-image/v0.2.1/install.sh | bash -s -- \
  --yes --all-profiles \
